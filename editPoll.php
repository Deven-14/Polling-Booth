...
if ($_SESSION["userid"] != $poll["userId"]) {
...
<section class="form">
    ...
    <form class="contact-form row" action="<?php echo 'includes/editPoll.inc.php?id=' . $poll_id ?>" method="post">
        <div class="form-field col-lg-12">
            ...
            <p class="input-text"><?php echo $poll["question"]; ?> </p>
        </div>
        <div class="form-field col-lg-12">
            <label style="color: #66fcf1" for="description">
                <h5>Edit Question Description</h5>
            </label>
            <input placeholder="Question Description" id="description" name="newDesc" class="input-text js-input" type="text" value="<?php echo $poll["description"]; ?>">
            ...
            foreach ($choices as $choice) { ?>
                <div class="form-field col-lg-12 ">
                    <ul id="options" style="list-style-type:none; margin-left: -30px">
                        <?php echo "<li class='input-text'>" . $choice["choiceName"] . "</li>"; ?>
                    </ul>
                </div>
            <?php
            }
